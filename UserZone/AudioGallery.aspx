<%@ Page Title="" Language="C#" MasterPageFile="~/UserZone/UserMaster.master" AutoEventWireup="true" CodeFile="AudioGallery.aspx.cs" Inherits="UserZone_AudioGallery" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [TblMaterial] WHERE ([category] = ?)">
        <SelectParameters>
            <asp:Parameter DefaultValue="audio" Name="category" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
